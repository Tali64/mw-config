	...
	'wgCreateWikiCannedResponses' => [
		'default' => [
			...
			'Decline reasons' => [
				...
				'Invalid sitename/subdomain (obscene wording)' => 'The scope and purpose of the wiki seem clear enough; however, the requested wiki name or subdomain is in violation of our Content Policy, which prohibits obscene wording in wiki names and subdomains. Please change it to something that is appropriate. Thank you.',
				...
				'Duplicate request (not enough information)' => 'Declining as a duplicate request that needs more information. Please do not edit this request and instead go back into your original request. Also, please do not submit duplicate requests. Thank you.',
	                        'Duplicate request (already approved)' => 'Declining as a duplicate of a request that has already been approved. Any changes to your wiki should be made via Special:ManageWiki locally or requested on the Stewards\' noticeboard or Phabricator when unavailable via ManageWiki. Thank you.',
